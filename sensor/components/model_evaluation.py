...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self)->ModelEvaluationArtifact:
        try:
            ...
            logging.info("Model Evaluation: Checking if Model is available or not")
            ...
            logging.info("Model Evalutaion : Loading latest and trained model")
            ...
            logging.info("Model Evaluation: Model Evaluation Artifact Generation")            
            model_evaluation_artifact = ModelEvaluationArtifact(
                    is_model_accepted=is_model_accepted, 
